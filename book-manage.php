...
$categoryRec = $obj->my_query("select * from ".$obj->getTable("var_category")." order by id ") ;
...
<?php //include_once("l-sidebar.php"); ?>
															...
															<div id="Div2">
																<fieldset id="Fieldset2">
																  <div style="margin-top:10px;" align="left">
																    <asp:Label id="lblHeader" runat="server" Width="320px" Font-Bold="True" Font-Size="Large">View book  </asp:Label></div>
																</fieldset>
															</div>
                                                            <?php
                                                            if($_POST["msg"]!="")
  ...
  <tr>
   ...
   <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="right" ><div class=" btnBg" align="center" style="width:120px; margin-top:5px; margin-left:5px;"><a href="book-add.php">Add book</a> </div></td>
  </tr>
</table>
            ...
            <tr >
           		 ...
           		 <div id="book_list" style="text-align:center"></div>
                 </td>
...
function showData(param , pageId)
{
	...
	if(document.getElementById("category_id").value=="" && document.getElementById("book_code").value=="" && document.getElementById("name").value=="" &&  document.getElementById("price").value=="" )
	{
		...
		if(document.getElementById("book_code").value!="")
		{
			parameters = parameters+"&book_code="+document.getElementById("book_code").value;
		}
...
//	$('#book_list').fadeOut('fast', function() {
				
		   callAjax("book_list", "listing-book.php", {
...
{
	document.getElementById('book_list').innerHTML="<br><br><img src='images/loading.gif' border='0'><br>Loading ...";
}
function redirect_action(frmAction, action, id , page_id)
{
	...
	if(action=='delete')
	{
		ans = confirm("Are you sure. Do you want to delete this book?");
		if(ans==true)
...
{
	show_popup('view_book_details.php?id='+record_id+'&btn=off');
}
showData('list');
</script>
</body>
