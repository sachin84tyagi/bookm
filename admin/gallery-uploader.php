...
{  
		 ...
		 else if($imageCount < 6)
		 {
			 ...
			 {  
				...
				$qry = "insert into temp_img set user_id = '".$_SESSION["sess_admin_id"]."' ,  image_name = 'thumb_".$image_to_upload."' " ;
				$obj->my_query($qry) ;
...
if(mysql_num_rows($res) > 0)
{
	...
	{
		  if(file_exists("../gallery/".$pimg['image_name']) )
		  {
			  
			  echo "<span><img src='../gallery/".str_replace('thumb','small',$pimg['image_name'])."'></span>";
...
<form name="frontImgFrm" action="gallery-uploader.php" enctype="multipart/form-data" method="post" style="font:11px 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#414141;">
