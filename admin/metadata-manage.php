															...
															<div id="Div2">
																<fieldset id="Fieldset2">
																  <div style="margin-top:10px;" align="left">
																    <asp:Label id="lblHeader" runat="server" Width="320px" Font-Bold="True" Font-Size="Large">View CMS Metadata  </asp:Label></div>
																</fieldset>
															</div>
                                                            <?php
                                                            if($_POST["msg"]!="")
  ...
  <tr>
    ...
    <td align="right" >&nbsp;
            ...
            <tr >
           		 ...
           		 <div id="metadata_list" style="text-align:center"></div>
                 </td>
...
{
	parameters="";
   // $('#metadata_list').fadeOut('fast', function() {
				
		   callAjax("metadata_list", "listing-metadata.php", {
...
function ends()
{
	$("#metadata_list").fadeIn("fast");
}

function process_begins()
{
	document.getElementById('metadata_list').innerHTML="<br><br><img src='images/loading.gif' border='0'><br>Loading ...";
}
function redirect_action(frmAction, action, id)
{
	...
	if(action=='delete')
	{
		ans = confirm("Are you sure. Do you want to delete this metadata?");
		if(ans==true)
...
{
	show_popup('view_metadata_details.php?id='+record_id+'&btn=off');
}
showData('list');
</script>
</body>
