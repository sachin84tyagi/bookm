...
?>
  ...
  <tr>
	...
	if($_POST['editKey']!="")
	{
		...
		$result = $obj->deleteData($obj->getTable("var_testimonials") , " and id=$edit_key ");
		...
		if($result==true)
		{
			...
			$msg_val = 'Testimonial has been deleted successfully!';
		}
		else
		{
			$action = "testimonials-manage.php";
			$msg_val = 'Sorry, Unable to delete Testimonial!';					
