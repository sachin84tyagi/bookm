...
function hide_popup()
{
															...
															<div id="Div2">
																<fieldset id="Fieldset2">
																  <div style="margin-top:10px;" align="left">
																    <asp:Label id="lblHeader" runat="server" Width="320px" Font-Bold="True" Font-Size="Large">View User  </asp:Label></div>
																</fieldset>
															</div>
                                                            <?php
                                                            if($_POST["msg"]!="")
  ...
  <tr>
    <th width="7%" align="right" scope="col">First Name :</th>
    <th width="15%" align="left" scope="col">
      <label>
        <input type="text" name="fname" id="fname" maxlength="100"/>
      </label>
 </th>
    <th  align="right" width="6%"  scope="col">Last Name :</th>
    <th align="left" scope="col"><input type="text" name="lname" id="lname"  maxlength="100" /></th>
  </tr>
  <tr>
    <td align="right">Email  :</td>
    <td align="left"><input type="text" name="email" id="email"  maxlength="100"/></td>
  ...
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="right" >
     <div class=" btnBg" align="center" style="width:120px; margin-top:5px; margin-left:5px;"><a href="user-add.php">Add User</a></div>
    </td>
  </tr>
</table>
	</fieldset>
            ...
            <tr >
           		 ...
           		 <div id="user_list" style="text-align:center;" ></div>
                 </td>
...
function showData(param , pageId)
{
	...
	if(document.getElementById("fname").value=="" && document.getElementById("lname").value=="" && document.getElementById("email").value=="" && document.getElementById("user_type").selectedIndex == 0 )
	{
		...
		{
			parameters = parameters+"&fname="+document.getElementById("fname").value;
		}
		if(document.getElementById("lname").value!="")
		{
			parameters = parameters+"&lname="+document.getElementById("lname").value;
		}
		if(document.getElementById("email").value!="")
		{
			parameters = parameters+"&email="+document.getElementById("email").value;
		}
		/*if(document.getElementById("user_type").selectedIndex > 0 )
		{
			parameters = parameters+"&user_type="+document.getElementById("user_type").options[];
		}*/
		//alert(parameters);
	}
 //	$('#user_list').fadeOut('fast', function() { 
				
		   callAjax("user_list", "listing-user.php", {
...
{
	document.getElementById('user_list').innerHTML="<br><br><img src='images/loading.gif' border='0'><br>Loading  ...";
}
