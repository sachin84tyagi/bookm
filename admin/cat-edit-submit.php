...
<?php
if($_POST["category"] !="" &&  $_POST['editKey'] != "" )
{       
		...
		$res = $obj->getAnyTableWhereData($obj->getTable("var_category")," and category ='".$_POST["category"]."' and parent_id='".$_POST["parent_id"]."' and  id = '".$editKey."' ");
		if($res["id"] !="")
		{
		 ...
		 else
		 {
		  	...
		  	$obj->editData($obj->getTable("var_category") , "id" , $editKey);
