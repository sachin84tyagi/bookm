...
$id = $_REQUEST["id"];
$res = $obj->getAnyTableWhereData($obj->getTable("var_testimonials")," and id='$id'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="42%">Auther Name :</td>
    <td width="58%"><?php echo $res["auther_name"] ; ?></td>
  </tr>
  <tr>
    <td>Title :</td>
    <td><?php echo $res["testimonials_title"] ;?></td>
  </tr>
   <tr>
    <td>Post Date :</td>
