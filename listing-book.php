...
if(!isset($_REQUEST["pagenum"]))
	...
	if(!empty($_REQUEST["paging"]))
		...
		$qry ="select * from bm_book where 1=1 and u_id = '22' $search_item order by id desc";
...
$qry ="select * from bm_book where 1=1 and u_id = '22' $search_item order by id desc limit $from, $paging ";
